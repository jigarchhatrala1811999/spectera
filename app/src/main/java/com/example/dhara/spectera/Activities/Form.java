...
public class Form extends AppCompatActivity
    ...
    public void initialize() {
        intent=new Intent(this, com.example.dhara.spectera.Activities.Qr_Scanner.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        int id = item.getItemId();
        if(id==R.id.menu_manageresponse){
            fragmentTransaction.add(R.id.myfragment,registration).commit();
        }
        if(id==R.id.menu_qrscanner){
